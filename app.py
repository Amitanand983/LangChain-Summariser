...
# # Token limits
# MAX_CHUNK_TOKENS = 1000  # Reduced to minimize latency
...
#                 # Process Audio File
#                 if audio_file:
#                     if audio_file.size > 200 * 1024 * 1024:  # 200 MB limit
#                         st.error("Audio file is too large. Please upload a file under 200 MB.")
#                     else:
#                         with tempfile.NamedTemporaryFile(delete=True) as temp_file:
#                             temp_file.write(audio_file.read())
#                             temp_file.flush()
